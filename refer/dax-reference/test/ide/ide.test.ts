...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders DAX_CALLER", () => {
    process.env["DAX_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode DAX_CALLER", () => {
    process.env["DAX_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown DAX_CALLER", () => {
    process.env["DAX_CALLER"] = "unknown"
