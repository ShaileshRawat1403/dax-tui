...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/dax.git")).toEqual({ owner: "sst", repo: "dax" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/dax")).toEqual({ owner: "sst", repo: "dax" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/dax.git")).toEqual({ owner: "sst", repo: "dax" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/dax")).toEqual({ owner: "sst", repo: "dax" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/dax.git")).toEqual({ owner: "sst", repo: "dax" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/dax")).toEqual({ owner: "sst", repo: "dax" })
})
